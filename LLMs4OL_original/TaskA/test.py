...
if __name__ == "__main__":
    ...
    templates = DataReader.load_json(config.templates_json)["bert"]
    ...
    model_path = os.path.basename(os.path.normpath(args.model_name))
    inference_model = InferenceFactory(config)(model_name=model_path)
    ...
    if "gpt" in args.model_name:
        ...
        print(f"scoring results in:{config.report_output}")
        # Serializing json
        json_object_result = json.dumps(report_dict, indent=4)
